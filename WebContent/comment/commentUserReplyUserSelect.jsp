...
<body>
	...
	<table>
		...
		<tr>
			...
			<td width="200"><%=commentUserReplyUser.getUser().getUserName()%>(<%=commentUserReplyUser.getUser().getUserId() %>)</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="200"><%=commentUserReplyUser.getComment().getCommentDate().substring(0,19) %></td>
		</tr>
	</table>
	<br>
	...
	<table>
		...
		<% } else { %>
			...
			<tr>
				...
				<td class="name"><%=replyUser.getUser().getUserName() %>(<%=replyUser.getReply().getReplyId()%>)</td>
